export { reference as studentKeys } from './student';
export { default as termKeys } from './term';
...
export { default as schoolKeys } from './school';
export { default as aliasKeys } from './alias';
