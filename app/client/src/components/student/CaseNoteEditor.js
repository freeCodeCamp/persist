        ...
        return (
            <form onSubmit={handleSubmit}>
                <Col style={{ minHeight: 100 }} xs={12} sm={6} md={6} lg={6}>
                    <Field name="description" component={TextField} floatingLabelText="Description" multiLine={true} rows={2} />
                </Col>
                <Col style={{ minHeight: 100 }} xs={12} sm={6} md={6} lg={6}>
                    <Field
                ...
                <Col style={{ minHeight: 100, display: 'flex', alignItems: 'center' }} xs={12} sm={6} md={6} lg={6}>
                    <Field name="needFollowUp" component={Toggle} label="Needs Follow Up" />
                </Col>
                <Col style={{ minHeight: 100, display: 'flex', alignItems: 'center' }} xs={12} sm={6} md={6} lg={6}>
