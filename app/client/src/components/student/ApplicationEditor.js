...
class ApplicationEditor extends Component {
    ...
    render() {
        const collegeField = applicationKeys.find(key => key.dbName === 'college');
        ...
        return (
            <form onSubmit={handleSubmit}>
                <Col style={{ minHeight: 100 }} xs={12} sm={6} md={6} lg={6}>
                    <ReduxFormGroup form={this} initValue={initialValues.college} field={collegeField} />
                ...
                <Col style={{ minHeight: 100, display: 'flex', alignItems: 'center' }} xs={12} sm={6} md={6} lg={6}>
                    <Field name="attending" component={Toggle} label="Attending" />
                </Col>
                <Col style={{ minHeight: 100, display: 'flex', alignItems: 'center' }} xs={12} sm={6} md={6} lg={6}>
                    <Field name="defer" component={Toggle} label="Defer" />
                </Col>
                <Clearfix visibleSmBlock visibleMdBlock visibleLgBlock />
                <Col style={{ minHeight: 100 }} xs={12} sm={6} md={6} lg={6}>
                    <Field name="notes" component={TextField} floatingLabelText="Notes" multiLine={true} rows={2} />
                </Col>
            </form>
        );
    }
