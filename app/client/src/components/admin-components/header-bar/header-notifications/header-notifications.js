  ...
  render() {
    ...
    return (
      <li className='dropdown notifications-menu'>
        <a href='#' className='dropdown-toggle' data-toggle='dropdown'><i className='fa fa-bell-o'></i> <span className='label label-warning'>{ that.state.notifications.length }</span></a>
