...
export default class HeaderTasks extends Component {
  ...
  render() {
    ...
    return (
      <li className='dropdown tasks-menu'>
        <a href='#' className='dropdown-toggle' data-toggle='dropdown'><i className='fa fa-flag-o'></i> <span className='label label-danger'>{ that.state.tasks.length }</span></a>
