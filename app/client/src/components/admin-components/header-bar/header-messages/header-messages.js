  ...
  render() {
    ...
    return (
      <li className='dropdown messages-menu'>
        <a href='#' className='dropdown-toggle' data-toggle='dropdown'><i className='fa fa-envelope-o'></i> <span className='label label-success'>{ that.state.messages.length }</span></a>
