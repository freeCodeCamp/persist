...
class ChartFilter extends React.Component {
    ...
    fieldsHTML(form) {
        const fields = ['studentSupportOrgName', 'hsGradYear', 'ethnicity', 'hs', 'intendedCollege', 'gender', 'cohort'];
        ...
        fields.forEach((field, i) => {
            ...
            HTML.push(
                <Col key={fieldObj.dbName} style={{ display: 'flex', justifyContent: 'center' }} xs={12} sm={6} md={6} lg={4}>
                    <ReduxFormGroup nullAllowed={nullValue} form={form} field={fieldObj} />
                </Col>
            );
            if ((i + 1) % 2 === 0) {
        ...
        extraFields.forEach((field, i) => {
            i = i + 7;
            HTML.push(
                <Col key={field} style={{ display: 'flex', justifyContent: 'center' }} xs={12} sm={6} md={6} lg={4}>
                    <Field name={field} component={SelectField} hintText="4 Year Graduate" floatingLabelText="4 Year Graduate">
        ...
        return (
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                <Row>
                    ...
                    <Col key="hsGPA" style={{ display: 'flex', justifyContent: 'center' }} xs={12} sm={6} md={6} lg={4}>
                        <Field
                            name="hsGPA"
