...
describe('Filter Colleges Action', () => {
		  ...
		  it('should create action FILTER_COLLEGE_ERROR after failing to get student', () => {
			    ...
			    const expectedActions = [
			      { type: FILTER_COLLEGE_PENDING },
			      { type: FILTER_COLLEGE_ERROR, payload: "Error: Request failed with status code 400"}
			    ];
		    	...
		    	// dispatch the action and check result
			    return store.dispatch(filterColleges('negtest'))
			    .then(() => {
