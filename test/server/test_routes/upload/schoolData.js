...
describe('/upload/schoolData', () => {
  describe('POST', () => {
      ...
      const tests = [
        {
          request: {
            method: 'post',
            url: encodeURI('/upload/schoolData')
          },
          response: {
            status: 401
          }
    ...
    it.skip('should save valid schoolData uploaded as a csv file', () => {});

    it('should return a status 500 error if the schoolData is invalid', (done) => {
