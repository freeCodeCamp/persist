...
describe('/upload/collegeData', () => {
  describe('POST', () => {
      ...
      const tests = [
        {
          request: {
            method: 'post',
            url: encodeURI('/upload/collegeData')
          },
          response: {
            status: 401
          }
    ...
    it.skip('should save valid collegeData uploaded as a csv file', () => {});

    it('should return a status 500 error if the collegeData is invalid', (done) => {
