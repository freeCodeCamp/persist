...
describe('/upload/applicationData', () => {
  describe('POST', () => {
      ...
      const tests = [
        {
          request: {
            method: 'post',
            url: encodeURI('/upload/applicationData')
          },
          response: {
            status: 401
          }
    ...
    it.skip('should save valid applicationData uploaded as a csv file', () => {});

    it('should return a status 500 error if the applicationData is invalid', (done) => {
